---
name: "source-command-bitforge-pencil"
description: "Emit a Pencil handoff prompt the user can paste into a Pencil session to wireframe the project"
---

# source-command-bitforge-pencil

Use this skill when the user asks to run `$source-command-bitforge-pencil` or the legacy `/bitforge:pencil` command.
