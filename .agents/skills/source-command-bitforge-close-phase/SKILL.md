---
name: "source-command-bitforge-close-phase"
description: "Verify acceptance, fill the Handoff, and mark the current phase complete"
---

# source-command-bitforge-close-phase

Use this skill when the user asks to run `$source-command-bitforge-close-phase` or the legacy `/bitforge:close-phase` command.
